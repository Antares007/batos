...
S(ntm) { book_of_text(b, o, t + W, u, s, E); }

S(conTinue) { ntm(b, o, u->t, u->upper, s, E); }
S(conTinue_Blue) { conTinue(Blue, o, t, u, s, E); }
S(conTinue_Green) { conTinue(Green, o, t, u, s, E); }

S(grow_Red);
S(conTinue_OrAnd_grow_Red) { conTinue(CE), grow_Red(CE); }
S(conTinue_Green_OrAnd_grow_Red) { conTinue_Green(CE), grow_Red(CE); }
S(conTinue_Blue_OrAnd_grow_Red) { conTinue_Blue(CE), grow_Red(CE); }
S(book_of_continuation) {
  ...
  nars[b * 5 + u->partition](CE);
}

static N(book_of_grow);
S(grow_Yellow) { book_of_grow(Yellow, o, 0, u, s, E); }
N(branch_and_grow_Yellow) {
  grow_Yellow(b, o, t, &(Ray){.upper = u, .t = t, .partition = b}, s, E);
}

S(grow_Red) { book_of_grow(Red, o, 0, u, s, E); }
S(branch_and_grow_Red) {
  grow_Red(b, o, t, &(Ray){.upper = u, .t = t, .partition = b}, s, E);
}
S(branch_and_grow_Yellow_uos) { branch_and_grow_Yellow(b, o, t, o[s], s, E); }
S(return_or_branch_and_grow_Yellow_uos) {
  o[u->t + 1] == o[t + 1] ? 1 : branch_and_grow_Yellow_uos(CE);
}
static N(book_of_recursion);
S(book_of_recursion_for_upper) { book_of_recursion(b, o, t, u->upper, s, E); }
S(return_or_book_of_recursion_for_upper) {
  o[u->t + 1] == o[t + 1] ? 1 : book_of_recursion_for_upper(CE);
}
S(ntm_Blue) { ntm(Blue, o, t, u, s, E); }
S(ntm_Blue_uos) { ntm_Blue(b, o, t, o[s], s, E); }
S(branch_and_grow_Red_uos) { branch_and_grow_Red(b, o, t, o[s], s, E); }

S(ntm_Blue_uos_or_branch_and_grow_Red_uos) {
  (o[u->t + 1] == o[t + 1] ? ntm_Blue_uos : branch_and_grow_Red_uos)(CE);
}
S(book_of_recursion) {
  static n_t nars[4 * 5] = {
...
static N(book_of_grow);
S(skip_ntm) { book_of_grow(b, o, t + W, u, s, E); }
...
S(os_book_of_recursion) { o[s] = u, book_of_recursion(CE); }
S(dispatch_ntm) { o[s] = ntm, ((n_t)o[t + 1])(CE); }
S(ntm_Green) { ntm(Green, o, t, u, s, E); }
S(dispatch_ntm_Green) { o[s] = ntm_Green, ((n_t)o[t + 1])(CE); }
S(book_of_text) {
  static n_t nars[4 * 4] = {
